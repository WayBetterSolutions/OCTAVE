...
version = 0.1
requirements = python3,shiboken6,PySide6,mutagen,spotipy,requests,urllib3,certifi,charset-normalizer,idna,Pillow,yt-dlp,ytmusicapi,rapidfuzz,python-slugify,text-unidecode,typing_extensions,redis,six
