...
from backend.music_dl.types.album import Album
from backend.music_dl.types.artist import Artist
from backend.music_dl.types.playlist import Playlist
from backend.music_dl.types.saved import Saved
from backend.music_dl.types.song import Song, SongList
from backend.music_dl.utils.metadata import get_file_metadata
from backend.music_dl.utils.spotify import SpotifyClient, SpotifyError
...
def get_simple_songs(
    ...
    for request in query:
        ...
        elif request.endswith(".spotdl") or request.endswith(".music_dl"):
